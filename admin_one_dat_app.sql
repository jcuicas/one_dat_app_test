...
--
-- Base de datos: `admin_one_dat_app`
--
CREATE DATABASE IF NOT EXISTS `admin_one_dat_app` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `admin_one_dat_app`;
...
('bar@gmail.com|127.0.0.1', 'i:1;', 1727128251),
('bar@gmail.com|127.0.0.1:timer', 'i:1727128251;', 1727128251);
...
(4, '2019_09_15_000010_create_tenants_table', 2),
(5, '2019_09_15_000020_create_domains_table', 2);
...
(1, 'José Cuicas', 'josecuicas@gmail.com', NULL, '$2y$12$J0eP12DrTaYxKEBwjJJZrOFqWCczJVzooKQ5hFps72T91B2yF9DpC', NULL, '2024-09-11 00:32:42', '2024-09-11 00:32:42');
